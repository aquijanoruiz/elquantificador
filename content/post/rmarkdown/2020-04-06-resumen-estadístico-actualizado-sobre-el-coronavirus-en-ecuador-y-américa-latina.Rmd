...
authors: 
  - Alonso Quijano
slug: resumen-estadistico-brote-coronavirus-ecuador-america-latina-rmarkdown
categories:
  - Salud
tags:
  - Coronavirus
...
**NOTA:** Todas las estadísticas están actualizadas al **domingo, 5 de abril de 2020**. Los datos se actualizan automáticamente todos los día en la mañana con los datos del día anterior.
...
url <- "https://github.com/aquijanoruiz/elquantificador_posts/raw/master/salud/2020-04-01-resumen-estadistico-sobre-el-coronavirus-en-ecuador-y-america-latina/americas.zip"
...
```{r, fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval=0.4, warning=FALSE, echo=TRUE}
confirmed_la_map # You must add the following code to your markdown: fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval=0.4
```
...
```{r, fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval=0.4, warning=FALSE, echo=TRUE}
deaths_la_map # You must add the following code to your markdown: fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval=0.4
```
Fuente: Center for Systems Science and Engineering (CSSE) de Johns Hopkins University
...
```{r, echo=TRUE, warning=FALSE }
world_population_country_url <- "https://raw.githubusercontent.com/aquijanoruiz/elquantificador_posts/master/salud/2020-04-01-resumen-estadistico-sobre-el-coronavirus-en-ecuador-y-america-latina/wb_population_country.csv"
