...
---
Parte  de mis proyectos de investigación están relacionados a la defecación al aire libre. Sí, así mismo. Defecar y orinar al aire libre son factores causales de desnutrición y muchos enfermedades físicas y mentales.
...
Aquí te muestro un mapa por provincia de cuántas viviendas NO tienen servicios higiénicos (de ningún tipo: ni letrinas). Ojo, no estoy asumiendo que todas las personas que viven en estas viviendas lo hacen al aire libre, a lo mejor van a la casa del vecino? 11% de hogares en Ecuador comparten su excusado con varias otras familias según el INEC; sin embargo, en época de aislamiento no estoy seguro cómo esto está funcionando.  Igual, este mapa nos permite observar cuántos hogares no tienen el privilegio de un baño exclusivo para ellos.  
