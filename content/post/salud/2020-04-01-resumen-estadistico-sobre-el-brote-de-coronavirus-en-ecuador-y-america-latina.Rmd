---
title: Resumen estadístico sobre el brote de coronavirus en Ecuador y América Latina (Marzo)
authors: 
  - Alonso Quijano
date: '2020-04-01'
...
tags:
  - Coronavirus
  - Mapas
description: 'La rápida propagación del Covid-19 en América Latina y el mundo ya ha alcanzado 18513 casos en América Latina. Te mostramos un resumen estadístico sobre el brote de coronavirus en Ecuador y América Latina. Hemos incluido tablas, gráficos y mapas para mejor ilustrar cómo ha afectado esta pandemia a nuestra región.'
...
El 29 de febrero de 2020, el Ecuador se convirtió en el tercer país en América Latina en confirmar su primer caso de Covid-19. Brasil y México fueron los primeros. En tan solo un mes, el virus logró propagarese en todos los países de la región y hasta ayer, 31 de marzo de 2020, se contabilizaron `r covid19_la_0331_sum$total_confirmed` casos confirmados, `r covid19_la_0331_sum$total_deaths` fallecidos y `r covid19_la_0331_sum$total_recovered` recuperados.

**Tabla 1. Número de casos confirmados, fallecidos, y recuperados por país al 31 de marzo de 2020**
...
tm_shape(la_countries_plus_map) + tm_borders(col = "grey25", lwd = 1, alpha = 0.4) +
  ...
  tm_fill(col = "Casos confirmados", palette = "OrRd", style = "fixed", 
          breaks = c(1, 10, 50, 100, 500, 1000, 2000, 3000, 4000, 6000),
...
deaths_la_map <- 
  ...
  tm_fill(col = "Fallecidos", palette = "OrRd", style = "fixed", 
          breaks = c(1, 10, 25, 50, 100, 200),
          legend.format = list(digits = 0), legend.show = TRUE) +
  tm_borders(col = "grey25", lwd = 1, alpha = 0.4) +
  tm_facets(by = "Fecha", ncol = 1, nrow = 1, free.coords = FALSE)
...
```{r, fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval=0.3, warning=FALSE, echo=FALSE}
confirmed_la_map
```
