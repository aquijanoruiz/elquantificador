...
**NOTA:** Todas las estadísticas están actualizadas al **martes, 7 de abril de 2020**. Los datos se actualizan automáticamente todos los día en la mañana con los datos del día anterior.
...
### Metodología
Los análisis y mapas fueron creados usando lenguaje `R`. Para más detalle sobre la metodología empleada en este artículo y para reproducir el código utilizado, te invitamos a consultar este [vínculo](https://elquantificador.org/post/rmarkdown/resumen-estadistico-brote-coronavirus-ecuador-america-latina-rmarkdown). Si tienes duda sobre la metodología o el código, escríbeme a alonso@elquantificador.org.