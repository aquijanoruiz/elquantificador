...
ggplot(data = google.trends, aes(x=date, y=coronavirus_EC)) + 
  ...
  annotate("text", x = as.Date("2020-03-14"), y = 86, label = "bolditalic('Se anuncia el cierre \n de fronteras')", parse = TRUE, size = 2.8, hjust = 0) +
  annotate("text", x = as.Date("2020-04-8"), y = 90, label = "bolditalic('Se reportan muertos \n en las calles de \n Guayaquil')", parse = TRUE, size = 2.8, hjust = 0) +
