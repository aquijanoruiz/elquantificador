...
Ya habíamos mencionado que los ingresos influían, pero no lo explicaban todo. También puede ser que los hogares de mayores ingresos gasten más en alimentación, pero no necesariamente en una mejor dieta. [Robert Jensen y Nolan Miller](https://www.aeaweb.org/articles?id=10.1257/aer.98.4.1553) en un experimento en China encontraron que cuando el precio del arroz era subsidiado a los más pobres, estos no compraban más arroz. Al contrario, consumían menos arroz, pero sí consumían más alimentos costosos y sabrosos como pescado y mariscos [@jensen2008giffen].
