...
El jueves pasado la ministra María Paula Romo dio a conocer que a partir de hoy, lunes 13 de abril, se empezaría a implementar un semáforo de colores rojo, naranja y verde que limitará o permitirá la movilización y actividades. La pregunta que nos hacemos es ¿con qué calidad de información (estadística) el gobierno tomará la decisión de flexibilizar la cuarentena en ciertas provincias, ciudades o sectores? En este artículo te presentaremos una solución viable que, de aplicar rigurosidad científica, permitirá recolectar estadísticas más confiables. Estoy hablando de las pruebas aleatorias utilizadas en estudios de prevalencia y que consisten en tomar una muestra significativa de individuos y realizar pruebas a modo de “lotería".
